...
x=1:903;
plot(x,Var1(1:903).*10,x,acceleration(1:903),x,var_test0_1(1:903));
%% 时间间隔(<11)阈值，误判检测
...
for n=1:length(gyro_xyzfan_Var)
    if gyro_xyzfan_Var(n)<0.00085
      gyro_xyzfan_Var0_1(n)=1;
    end
end 
x=1:903;
plot(x,gyro_xyzfan_Var(1:903).*10,x,gyro_xyzfan(1:903),x,gyro_xyzfan_Var0_1(1:903));
%% 时间间隔阈值，误判检测
...
x=1:903;
plot(x,gyro_xyzfan_Var(1:903).*10,x,gyro_xyzfan(1:903),x,var_gyro_0_1(1:903));
%步态结果区分画图（检测结果0:1000）对不对
x=1:903;
plot(x,acceleration(1:903),x,gyro_xyzfan(1:903),x,var_gyro_0_1(1:903));
plot(x,ay(1:903),x,var_gyro_0_1(1:903))
plot(x,acceleration(1:903))