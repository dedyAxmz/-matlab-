...
x=2000:2500;
plot(x,Var1(2000:2500).*10,x,acceleration(2000:2500),x,var_test0_1(2000:2500));
%% 时间间隔(<11)阈值，误判检测
...
for n=1:length(gyro_xyzfan_Var)
    if gyro_xyzfan_Var(n)<0.01
      gyro_xyzfan_Var0_1(n)=1;
    end
end 
x=2000:2500;
plot(x,gyro_xyzfan_Var(2000:2500).*10,x,gyro_xyzfan(2000:2500),x,gyro_xyzfan_Var0_1(2000:2500));
%% 时间间隔阈值，误判检测
...
x=2000:2500;
plot(x,gyro_xyzfan_Var(2000:2500).*10,x,gyro_xyzfan(2000:2500),x,var_gyro_0_1(2000:2500));
%步态结果区分画图（检测结果0:1000）对不对
x=2000:2500;
plot(x,acceleration(2000:2500),x,gyro_xyzfan(2000:2500),x,var_gyro_0_1(2000:2500));
plot(x,ay(2000:2500),x,var_gyro_0_1(2000:2500))
y=1:1000;
plot(y,data(1:1000,2))