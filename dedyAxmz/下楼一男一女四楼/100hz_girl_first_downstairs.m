...
clear;
%数据预处理
DATA=xlsread('C:\Users\201810\Desktop\dedyAxmz\数据\100Hz数据\下楼\下楼女一组.xlsx',1);%体育场
%data=DATA(:,1:3).*9.8;
data=DATA(:,3:8);
...
%局部峰值位置统计
%波峰，波谷统一在一起
[pks,locs] = findpeaks(ay,'MinPeakHeight',0.36,'MinPeakDistance',16);
peaks_locs=[locs;3358];
[pks,locs] = findpeaks(-ay,'MinPeakHeight',-0.22,'MinPeakDistance',70);
valley_locs=[locs;3482];
